...
export function AuthScreen() {
  ...
  return (
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden p-4">
      {/* Apple-green glow background */}
      <div className="pointer-events-none fixed inset-0 -z-10 bg-[radial-gradient(60%_50%_at_50%_0%,oklch(0.84_0.16_124/0.14),transparent)]" />
      ...
      >
        <div className="flex items-center gap-2">
          <Logo className="size-8 rounded-md shadow-lg shadow-lime-400/40" />
          <div>
